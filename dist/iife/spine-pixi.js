...
`;
  ...
  var spineTextureAtlasLoader = {
    ...
    loader: {
      ...
      test(url) {
        return (0, import_assets2.checkExtension)(url, ".atlas");
      },
      async load(url) {
      ...
      testParse(asset, options) {
        const isExtensionRight = (0, import_assets2.checkExtension)(options.src, ".atlas");
  ...
  var spineLoaderExtension = {
    ...
    loader: {
      ...
      test(url) {
        return (0, import_assets3.checkExtension)(url, ".skel");
      },
      async load(url) {
      ...
      testParse(asset, options) {
        const isJsonSpineModel = (0, import_assets3.checkExtension)(options.src, ".json") && isJson(asset);
        const isBinarySpineModel = (0, import_assets3.checkExtension)(options.src, ".skel") && isBuffer(asset);
